/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 22ac9cfa2a968adebbbd0b4f5b028cb8)
...
interface __BaseEnv_Env {
	...
	POLAR_ANNUAL_PRODUCT_ID: string;
	...
	AXIOM_TOKEN: string;
	BOARD: DurableObjectNamespace<import("./src/server").BoardObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "BoardObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AXIOM_ENDPOINT" | "MCP_ALLOWED_ORIGINS" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_APP_SLUG" | "GITHUB_WEBHOOK_SECRET" | "POLAR_SERVER" | "POLAR_ACCESS_TOKEN" | "POLAR_WEBHOOK_SECRET" | "POLAR_ORGANIZATION_ID" | "POLAR_MONTHLY_PRODUCT_ID" | "POLAR_ANNUAL_PRODUCT_ID" | "BILLING_CHECKOUT_ENABLED" | "BILLING_ENFORCEMENT_ENABLED" | "TELEMETRY_ENVIRONMENT" | "TELEMETRY_ENABLED" | "TELEMETRY_RELEASE" | "AXIOM_TOKEN">> {}
}
